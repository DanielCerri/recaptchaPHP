    ...
    <form action="cadastrar.php"  method="POST" name="formulario" > 
        ...
        <div class="form-group">
            <div class="   col-md-6 offset-md-3">
                ...
                <input type="text" name="email" class="form-control " placeholder=" Usuário ou E-MAIL" required="" >    
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-6 offset-md-3">
            	<div class="g-recaptcha" data-sitekey="6LfVy-sUAAAAACgPQXHhQdSvTZaRkpQK1uDmXDww"></div>
